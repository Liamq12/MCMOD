...
public class MOD {
    ...
    public static HashMap<String, ArrayList> MASTER_LUCKY_BLOCKS = new HashMap<String, ArrayList>();
...
//	}
	...
	ItemInit.registerBlockItem(name);
	// BlockInit.registerBlock(name);
	//BlockInit.registerLuckyBlock(name, hardness, resistance, harvestTool, harvestLevel);
	writeBlockJson(name);
