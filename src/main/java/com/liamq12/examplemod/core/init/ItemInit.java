...
public class ItemInit {
	...
	public static void registerItem(String itemName) {
		RegistryObject<Item> active = ITEMS.register(itemName, () -> new Item(new Item.Properties().group(ItemGroup.MISC)));
	...
	public static void registerBlockItem(String blockName) {
		BLOCK_ITEM_MAP.put(blockName, ITEMS.register(blockName, () -> new BlockItem(BlockInit.BLOCK_MAP.get(blockName).get(), new Item.Properties().group(ItemGroup.BUILDING_BLOCKS))));
	}
	...
	public static void registerSpecialItem(String specialItemName, Effect effect) {
		RegistryObject<Item> active = ITEMS.register(specialItemName, () -> new SpecialItem(new Item.Properties().group(ItemGroup.MISC), effect));
	...
	public static void registerFoodItem(String foodName, Effect effect, int time, int amplifier, float chance, int regen, float saturation) {
		FOOD_ITEM_MAP.put(foodName, ITEMS.register(foodName, () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().effect(() -> new EffectInstance(effect, time, amplifier), chance).hunger(regen).saturation(saturation).build()))));
